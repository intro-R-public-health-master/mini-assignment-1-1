...
**Due Saturday, September 14 @ 11:59pm through Github**

Your next assignment is to recreate eight plots with the `ggplot` using the subset of `nmes.data` we worked with in class.
...
* In the window that opens, **stage** your changes by clicking the check boxes next to the `Mini1-1.Rmd` and `Mini1-1.html` files.
